--[[
    Gaming Hub
    UI/Sudoku_SettingsPanel.lua
    Version: 1.0.0 (Multilanguage via Language.lua)

    Alle sichtbaren Strings kommen aus GamingHub.GetLocaleTable("SUDOKU").
]]
...
local function BuildSudokuSettingsPanel(parent)
    ...
    hint:SetPoint("BOTTOMLEFT", cB, "BOTTOMLEFT", 0, 4)
    ...
    resetBtn:SetScript("OnClick", function()
        ...
        BuildSudokuSettingsPanel(parent)
    end)
...
GamingHub.SettingsPanel._builders["SUDOKU"] = BuildSudokuSettingsPanel
